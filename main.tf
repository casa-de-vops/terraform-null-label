locals {
  ...
  input = {
    ...
    organization = var.organization == null ? local.input_context.organization : var.organization
    ...
    organization_codes  = var.organization_codes == null ? local.input_context.organization_codes : var.organization_codes
  ...
  string_label_names = ["organization", "location", "environment", "application"]
  ...
  organization      = local.formatted_labels["organization"]
  organization_name = try(local.organization_codes[local.organization].display_name, "")
  organization_code = try(local.organization_codes[local.organization].code, "")
  ...
  organization_codes = local.input.organization_codes == null ? local.defaults.organization_codes : local.input.organization_codes
  ...
  id_context = {
    ...
    organization_code = local.organization_code
  ...
  output_context = {
    ...
    organization_codes  = local.organization_codes
